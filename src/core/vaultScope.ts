...
export function normalizeAllowedVaultFolders(folders: string[] | undefined): string[] {
  // Compared case-sensitively: on a case-sensitive vault "public" and "Public" are different
  // folders, and matching loosely would grant access to one the user never configured.
  return (folders ?? [])
