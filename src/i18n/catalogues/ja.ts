...
export const ja = {
  ...
  "input.readAloudChip": "回答を読み上げ中",
  "input.readAloudChipOff": "読み上げをOFFにする",
  "input.voiceConversation": "音声で会話",
  "input.voiceConversationChip": "音声で会話中",
  "input.voiceConversationEnd": "音声会話を終了",
  "voice.popupFailed": "speech-popupを開けませんでした。speech-popupを起動してから再試行してください。",
  "settings.readAloudRate": "読み上げ速度",
  "settings.readAloudRate.desc": "回答を読み上げる速さ。1.0 が音声の既定の速さです。",
  "settings.speechPopupCommand": "speech-popupコマンド",
  "settings.speechPopupCommand.desc": "speech-popupの実行ファイルのパス。空欄ならPATHの`speech-popup`を使います。",
