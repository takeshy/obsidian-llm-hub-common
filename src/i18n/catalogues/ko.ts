...
export const ko = {
  ...
  "input.readAloudRate": "속도",
  "input.readAloudChip": "응답을 읽어 주는 중",
  "input.readAloudChipOff": "읽어 주기 끄기",
  "input.voiceConversation": "음성 대화",
  "input.voiceConversationChip": "음성 대화 중",
  "input.voiceConversationEnd": "음성 대화 종료",
  "voice.popupFailed": "speech-popup을 열 수 없습니다. speech-popup을 실행한 뒤 다시 시도하세요.",
  "settings.readAloudRate": "읽어 주기 속도",
  "settings.readAloudRate.desc": "응답을 읽어 주는 속도입니다. 1.0이 음성의 기본 속도입니다.",
  "settings.speechPopupCommand": "speech-popup 명령",
  "settings.speechPopupCommand.desc": "speech-popup 실행 파일 경로. 비워 두면 PATH의 `speech-popup`을 사용합니다.",
