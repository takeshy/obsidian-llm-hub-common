...
function fileExists(path: string): boolean {
  try {
    // Load Node only when normalizing a desktop stdio command.
    // eslint-disable-next-line @typescript-eslint/no-require-imports -- Settings are also loaded on mobile.
