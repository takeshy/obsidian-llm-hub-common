...
import { generateKeyPair, encryptPrivateKey } from "../core/index.js";
import { ConfirmModal } from "../ui/ConfirmModal.js";
import { formatError } from "../core/index.js";
import { setDestructiveButton } from "../obsidian/buttonCompat.js";
import type { SettingsContext, SettingsPlugin } from "./context.js";
import { DEFAULT_ENCRYPTION_SETTINGS, type EncryptionSettings } from "./types.js";

/** What this section reads and writes. */
export interface EncryptionSettingsPlugin extends SettingsPlugin {
  settings: { encryption: EncryptionSettings };
}

export function displayEncryptionSettings(containerEl: HTMLElement, ctx: SettingsContext<EncryptionSettingsPlugin>): void {
