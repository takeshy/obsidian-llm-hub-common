...
export interface ExternalSkillSettingsPlugin extends SettingsPlugin {
  settings: { skillsFolder?: string };
  settingsEmitter?: { emit(event: "skills-changed"): void };
}
...
async function loadState(ctx: SettingsContext<ExternalSkillSettingsPlugin>, force: boolean): Promise<void> {
  if (loading) return;
...
async function installSkill(ctx: SettingsContext<ExternalSkillSettingsPlugin>, id: string): Promise<void> {
  try {
...
async function checkForUpdate(ctx: SettingsContext<ExternalSkillSettingsPlugin>, installed: InstalledSkill): Promise<void> {
...
export function displayExternalSkillSettings(containerEl: HTMLElement, ctx: SettingsContext<ExternalSkillSettingsPlugin>): void {
